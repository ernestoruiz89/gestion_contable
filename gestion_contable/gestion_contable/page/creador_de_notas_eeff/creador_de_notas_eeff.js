...
class CreadorNotasEEFF {
    ...
    setup_styles() {
        ...
        style.textContent = `
            ...
            [data-theme="dark"] .cne-matrix-cell.computed { background: var(--control-bg) !important; border-style: dashed !important; border-color: #f8fafc !important; }
            ...
            .cne-matrix-cell.computed{background:#f8fafc;border-style:dashed!important;border-color:#f8fafc!important}
